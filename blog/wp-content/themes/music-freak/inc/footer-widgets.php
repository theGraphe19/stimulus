...
class Music_Freak_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'music_freak';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'music-freak' ), $i ),
...
// Initialize.
$music_freak_footer_widgets = new Music_Freak_Footer_Widgets();

 ...
 */
class Music_Freak_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Music_Freak_Dropdown_Category_Control extends WP_Customize_Control {
...
class Music_Freak_Note_Control extends WP_Customize_Control {
...
class Music_Freak_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Music_Freak_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="music-freak-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Music_Freak_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="music-freak-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Music_Freak_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Music_Freak_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="music-freak-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="music-freak-sortable-input sortable-hideme" name="<?php echo esc_attr( $trimmed_value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $value ); ?> </span>
          <i class="dashicons dashicons-menu music-freak-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="music-freak-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Music_Freak_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="music-freak-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'music-freak' ); ?>" class="music-freak-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Music_Freak_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Music_Freak_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string

...
$config = array(
    ...
    'recommended_actions'        => array(
        'creative-blocks' => array(
            'title' => esc_html__( 'Install Creative Blocks','blogberg' ),
            'desc' => sprintf( esc_html__( 'The Creative Blocks, an elegant professional page building blocks for the WordPress Gutenberg block editor', 'blogberg' ) ),
            'id' => 'creative-blocks',
    ...
    'faq'      => array(
        'first' => array (
            ...
            'desc' => esc_html__( 'Blogberg supports Creative Blocks, WooCommerce, Contact From 7 and MailChimp for WordPress.','blogberg' ),
            'is_new_tab' => true
        ),
    ),
    // Support content tab.
